...
import { Camera, Save, Loader2, User, Mail, Phone, Building, MapPin, LogOut, X, Edit2 } from 'lucide-react';
...
const Settings = () => {
  ...
  const handleCropAndUpload = async () => {
    try {
      ...
      // Auto-save the new image to the user profile
  ...
  return (
    <div className="min-h-screen py-24 px-6 relative" style={{ backgroundColor: '#050505' }}>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-extrabold mb-2" style={{ color: 'white' }}>Profile Settings</h1>
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E87C41] transition-all"
                        style={{ backgroundColor: '#1a1a1a', border: '1px solid rgba(255,255,255,0.1)', color: 'white' }}
                      />
                    ) : (
                      <div className="w-full px-4 py-3 rounded-xl" style={{ backgroundColor: '#1a1a1a', border: '1px solid transparent', color: 'white' }}>
                        {formData.name || '-'}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {isEditing ? (
                      <input
                        ...
                        disabled
                        className="w-full px-4 py-3 rounded-xl focus:outline-none cursor-not-allowed opacity-70"
                        style={{ backgroundColor: '#1a1a1a', border: '1px solid rgba(255,255,255,0.1)', color: '#9ca3af' }}
                      />
                    ) : (
                      <div className="w-full px-4 py-3 rounded-xl" style={{ backgroundColor: '#1a1a1a', border: '1px solid transparent', color: '#9ca3af' }}>
                        {formData.email}
                      </div>
                    )}
                  </div>
                ...
                {isEditing && (
                  <div className="pt-4 flex justify-end space-x-4">
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 px-8 py-3 rounded-xl font-bold text-white transition-all duration-300 shadow-lg hover:-translate-y-0.5 disabled:opacity-70 disabled:hover:translate-y-0"
                      style={{ 
          ...
          <div className="bg-[#111] border border-white/10 p-6 rounded-3xl w-full max-w-md relative animate-scale-in shadow-2xl">
            ...
            <div className="flex gap-4">
              <button 
                ...
                className="flex-1 py-3 rounded-xl text-white font-bold bg-white/5 hover:bg-white/10 transition-colors"
              >
                Cancel
              </button>
              <button 
                ...
                disabled={uploading}
                className="flex-1 py-3 rounded-xl text-white font-bold bg-[#E87C41] hover:bg-[#d66a30] transition-colors flex justify-center items-center gap-2 shadow-[0_4px_14px_rgba(232,124,65,0.4)]"
              >
